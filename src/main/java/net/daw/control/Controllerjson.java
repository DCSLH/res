...
public class Controllerjson extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception {
        ...
        try {
            String strNombreOperacion = "net.daw.operationjson." + oContexto.getOperacion();
            ...
            try {
                ...
                throw new ServletException("Controllerjson: Error: ServletException " + e.getMessage());
            }
            //getServletContext().getRequestDispatcher("/index.jsp").forward(request, response);
            getServletContext().getRequestDispatcher("/jsp/jason.jsp").forward(request, response);
        } catch (InstantiationException e) {
            throw new ServletException("Controllerjson: Error: InstantiationException " + e.getMessage());
        } catch (IllegalAccessException e) {
            throw new ServletException("Controllerjson: Error: IllegalAccessException " + e.getMessage());
